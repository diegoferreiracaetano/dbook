...
private class FakeFlightRepository : FlightRepository {
	...
	override fun search(originIataCode: String, destinationIataCode: String, date: LocalDate): List<Flight> = emptyList()
}
...
class RegisterFlightUseCaseTest {
	...
	private fun command(origin: String = "GRU", destination: String = "GIG") = RegisterFlightCommand(
		flightNumber = "DB1234",
